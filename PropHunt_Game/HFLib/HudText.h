...
public:
	...
	void UpdatePosition() {
		...
		destRect.x = (int)gameObject->position.x + GAME_MANAGER->hWidth - m_hWidth;
		destRect.y = -(int)gameObject->position.y + GAME_MANAGER->hHeight - m_hHeight;
